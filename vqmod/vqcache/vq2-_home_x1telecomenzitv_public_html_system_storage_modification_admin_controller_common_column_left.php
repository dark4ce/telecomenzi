		...
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			*/	
			...
			if ($this->user->hasPermission('access', 'sale/order')) {
				$sale[] = array(
					'name'	   => 'Orders GLS',
					'href'     => $this->url->link('sale/order/ordersgls', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);	
			}
          ...
          if ($this->user->hasPermission('access', 'extension/module/seo_urls')) {
			...
			$data['text_other_status'] = $this->language->get('text_other_status');
		            ...
		            $menu_smartbill[] = array(
					            ...
					            'href'     => $this->url->link('smartbill/login', 'token=' . $this->session->data['token'], true),
					            'children' => array()
				          );
		            $menu_smartbill[] = array(
					            'name'	   => $this->language->get('text_smartbill_settings'),
					            'href'     => $this->url->link('smartbill/settings', 'token=' . $this->session->data['token'], true),
					            'children' => array()
				          );
		            $menu_smartbill[] = array(
