...
$_['goToSmartsuppText'] = 'Go to Smartsupp to start chatting with visitors, customize chat box design and access all features.';
$_['goToSmartsupp'] = 'Go to Smartsupp';
$_['openInNewTab'] = '(This will open a new browser tab)';
$_['advancedSettings'] = 'Advanced settings';
$_['optionalCode'] = 'Optional code for advanced customization with <a href="https://developers.smartsupp.com?utm_source=OpenCart&utm_medium=integration&utm_campaign=link" target="_blank">Smartsupp API</a>';
