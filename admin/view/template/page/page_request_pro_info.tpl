      ...
      <div class="col-md-6">
        <div class="panel panel-default">
          ...
          <table class="table">
            <tbody>
              <tr>
                <td style="width: 1%"><button data-toggle="tooltip" title="<?php echo $text_page_form_pro_title; ?>" class="btn btn-primary"><i class="fa fa-file fa-fw"></i></button></td>
                <td><a href="<?php echo $page_form_pro_href; ?>" target="_blank"><?php echo $page_form_pro_title; ?></a></td>
              </tr>
              <tr>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="panel panel-default">
          ...
          <table class="table">
            <tr>
              <td style="width: 1%;"><button data-toggle="tooltip" title="<?php echo $text_product; ?>" class="btn btn-primary"><i class="fa fa-link fa-fw"></i></button></td>
              <td>
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <table class="table table-bordered table-responsive">
          ...
          <tbody>
            <?php foreach($page_request_pro_options as $page_request_pro_option) { ?>
            <tr>
              <td class="text-left"><label><?php echo $page_request_pro_option['name']; ?></label></td>
              <td class="text-left">
                <?php if ($page_request_pro_option['type'] != 'file') { ?>
                <?php echo $page_request_pro_option['value']; ?>                
                <?php } else { ?>
                <a href="<?php echo $page_request_pro_option['href']; ?>"><?php echo $page_request_pro_option['value']; ?></a>
                <?php } ?>
              </td>
            </tr>
            <?php } ?>
