        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-page" class="form-horizontal">
          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="page_form_pro_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="page_form_pro_description[<?php echo $language['language_id']; ?>][bottom_description]" placeholder="<?php echo $entry_bottom_description; ?>" id="input-bottom-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['bottom_description'] : ''; ?></textarea>
                    </div>
                  </div>
                  <fieldset>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="page_form_pro_description[<?php echo $language['language_id']; ?>][fieldset_title]" value="<?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['fieldset_title'] : ''; ?>" placeholder="<?php echo $entry_fieldset_title; ?>" id="input-fieldset-title<?php echo $language['language_id']; ?>" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="col-sm-10">
                        <input type="text" name="page_form_pro_description[<?php echo $language['language_id']; ?>][submit_button]" value="<?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['submit_button'] : ''; ?>" placeholder="<?php echo $entry_submit_button; ?>" id="input-submit-button<?php echo $language['language_id']; ?>" class="form-control" />
                      </div>
                    </div>
                  </fieldset>
                </div>
            ...
            <div class="tab-pane" id="tab-link">
              <fieldset>
                <legend><?php echo $leg_customer_group; ?></legend>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      ...
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($customer_group['customer_group_id'], $page_form_pro_customer_group)) { ?>
                          <input type="checkbox" name="page_form_pro_customer_group[]" value="<?php echo $customer_group['customer_group_id']; ?>" checked="checked" />
                          <?php echo $customer_group['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="page_form_pro_customer_group[]" value="<?php echo $customer_group['customer_group_id']; ?>" />
                          <?php echo $customer_group['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
              ...
              <fieldset>
                <legend><?php echo $leg_store; ?></legend>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <div class="well well-sm" style="height: 150px; overflow: auto;">
                      <div class="checkbox">
                        <label>
                          <?php if (in_array(0, $page_form_pro_store)) { ?>
                          <input type="checkbox" name="page_form_pro_store[]" value="0" checked="checked" />
                          <?php echo $text_default; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="page_form_pro_store[]" value="0" />
                          <?php echo $text_default; ?>
                          <?php } ?>
                        </label>
                      </div>
                      ...
                      <div class="checkbox">
                        <label>
                          <?php if (in_array($store['store_id'], $page_form_pro_store)) { ?>
                          <input type="checkbox" name="page_form_pro_store[]" value="<?php echo $store['store_id']; ?>" checked="checked" />
                          <?php echo $store['name']; ?>
                          <?php } else { ?>
                          <input type="checkbox" name="page_form_pro_store[]" value="<?php echo $store['store_id']; ?>" />
                          <?php echo $store['name']; ?>
                          <?php } ?>
                        </label>
                      </div>
              ...
              <fieldset>
                <legend><?php echo $leg_product; ?></legend>
                <div class="form-group">
                  <label class="col-sm-2 control-label"><?php echo $entry_producttype; ?></label>
                  <div class="col-sm-10">
                    <label class="radio-inline">
                      <input type="radio" name="producttype" value="no" <?php echo $producttype == 'no' ? 'checked="checked"' : ''; ?> /> <?php echo $text_no_product; ?>
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="producttype" value="all" <?php echo $producttype == 'all' ? 'checked="checked"' : ''; ?> /> <?php echo $text_all_product; ?>
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="producttype" value="choose" <?php echo $producttype == 'choose' ? 'checked="checked"' : ''; ?> /> <?php echo $text_choose_product; ?>
                    </label>
                  </div>
                </div>
                <div class="form-group product-group <?php echo $producttype != 'choose' ? 'hide' : ''; ?>">
                  ...
                  <div class="col-sm-10">
                    ...
                    <?php foreach ($page_form_pro_products as $page_form_pro_product) { ?>
                    <div id="formbuilder-product<?php echo $page_form_pro_product['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $page_form_pro_product['name']; ?>
                      <input type="hidden" name="page_form_pro_product[]" value="<?php echo $page_form_pro_product['product_id']; ?>" />
                    </div>
                    <?php } ?>
                    </div>
                  </div>
                ...
                <div class="form-group pbutton_title <?php echo $producttype == 'no' ? 'hide' : ''; ?>"">
                  ...
                  <div class="col-sm-10">
                    ...
                    <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                      <input type="text" name="page_form_pro_description[<?php echo $language['language_id']; ?>][pbutton_title]" value="<?php echo isset($page_form_pro_description[$language['language_id']]['pbutton_title']) ? $page_form_pro_description[$language['language_id']]['pbutton_title'] : ''; ?>" placeholder="<?php echo $entry_pbutton_title; ?>" class="form-control" />
                    </div>
                    <?php } ?>
                  </div>
                </div>
            ...
            <div class="tab-pane" id="tab-fields">
              <div class="row">
                ...
                <div class="col-sm-8 col-xs-12 col-md-5">
                  ...
                  <?php $field_row = 0; ?>
                  <?php $page_form_pro_option_value_row = 0; ?>
                    <?php foreach($fields as $field) { ?>
                    <div class="tab-pane" id="tab-field<?php echo $field_row; ?>">
                      <fieldset>
                        <legend><?php echo $text_lang_setting ?></legend>
                        <input type="hidden" name="page_form_pro_field[<?php echo $field_row; ?>][page_form_pro_option_id]" value="<?php echo (isset($field['page_form_pro_option_id']) ? $field['page_form_pro_option_id'] : ''); ?>" />
                          ...
                          <div class="tab-content">
                            ...
                            <div class="tab-pane" id="field-language<?php echo $field_row; ?>-<?php echo $language['language_id']; ?>">
                              <div class="form-group required">
                                ...
                                <div class="col-sm-12">
                                  <input type="text" name="page_form_pro_field[<?php echo $field_row; ?>][description][<?php echo $language['language_id']; ?>][field_name]" value="<?php echo isset($field['description'][$language['language_id']]['field_name']) ? $field['description'][$language['language_id']]['field_name'] : ''; ?>" placeholder="<?php echo $entry_field_name; ?>" class="form-control" />
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                  <textarea name="page_form_pro_field[<?php echo $field_row; ?>][description][<?php echo $language['language_id']; ?>][field_help]" placeholder="<?php echo $entry_field_help; ?>" class="form-control"><?php echo isset($field['description'][$language['language_id']]['field_help']) ? $field['description'][$language['language_id']]['field_help'] : ''; ?></textarea>
                                </div>
                              </div>
                              <div class="form-group field-placeholder<?php echo $field_row; ?>">
                                ...
                                <div class="col-sm-12">
                                  <input type="text" name="page_form_pro_field[<?php echo $field_row; ?>][description][<?php echo $language['language_id']; ?>][field_placeholder]" value="<?php echo isset($field['description'][$language['language_id']]['field_placeholder']) ? $field['description'][$language['language_id']]['field_placeholder'] : ''; ?>" placeholder="<?php echo $entry_field_placeholder; ?>" class="form-control" />
                                </div>
                              </div>
                              <div class="form-group field-error<?php echo $field_row; ?>">
                                ...
                                <div class="col-sm-12">
                                  <input type="text" name="page_form_pro_field[<?php echo $field_row; ?>][description][<?php echo $language['language_id']; ?>][field_error]" value="<?php echo isset($field['description'][$language['language_id']]['field_error']) ? $field['description'][$language['language_id']]['field_error'] : ''; ?>" placeholder="<?php echo $entry_field_error; ?>" class="form-control" />
                                </div>
                              </div>
                            </div>
                            <?php } ?>
                      ...
                      <fieldset>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-12">
                            <select name="page_form_pro_field[<?php echo $field_row; ?>][status]" class="form-control field-status" rel="<?php echo $field_row; ?>">
                              <?php if ($field['status']) { ?>
                              <option value="1" selected="selected"><?php echo $text_enabled; ?></option>
                              <option value="0"><?php echo $text_disabled; ?></option>
                              <?php } else { ?>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-12">
                            <select name="page_form_pro_field[<?php echo $field_row; ?>][required]" class="form-control field-required" rel="<?php echo $field_row; ?>">
                        ...
                        <div class="form-group hide">
                          ...
                          <div class="col-sm-12">
                            <input type="text" name="page_form_pro_field[<?php echo $field_row; ?>][sort_order]"  value="<?php echo $field['sort_order']; ?>" class="form-control field-sortorder" />
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-sm-12 control-label"><span data-toggle="tooltip" title="<?php echo $help_type; ?>"><?php echo $entry_type; ?></span></label>
                          <div class="col-sm-12">
                            <select name="page_form_pro_field[<?php echo $field_row; ?>][type]" class="form-control field-type" rel="<?php echo $field_row; ?>">
                      ...
                      <fieldset id="field-values<?php echo $field_row;  ?>">
                        ...
                        <table id="pageformoption-value<?php echo $field_row; ?>" class="table table-striped table-bordered table-hover">
                          ...
                          <tbody>
                            ...
                            <?php foreach ($field['option_value'] as $page_form_pro_option_value) { ?>
                            <tr id="pageformoption-value-row<?php echo $field_row; ?>-<?php echo $page_form_pro_option_value_row; ?>">
                              <td class="text-left">
                                <input type="hidden" name="page_form_pro_field[<?php echo $field_row; ?>][option_value][<?php echo $page_form_pro_option_value_row; ?>][page_form_pro_option_value_id]" value="<?php echo $page_form_pro_option_value['page_form_pro_option_value_id']; ?>" />
                                <?php foreach ($languages as $language) { ?>
                                ...
                                <?php if(VERSION >= '2.2.0.0') { ?>
                                  ...
                                  <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
                                  <?php } ?></span>
                                  <input type="text" name="page_form_pro_field[<?php echo $field_row; ?>][option_value][<?php echo $page_form_pro_option_value_row; ?>][page_form_pro_option_value_description][<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($page_form_pro_option_value['page_form_pro_option_value_description'][$language['language_id']]['name']) ? $page_form_pro_option_value['page_form_pro_option_value_description'][$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />
                                  <?php if (isset($error_value_name[$field_row][$page_form_pro_option_value_row][$language['language_id']])) { ?>
                                  <div class="text-danger"><?php echo $error_value_name[$field_row][$page_form_pro_option_value_row][$language['language_id']]; ?></div>
                                  <?php } ?>
                                </div>
                                <?php } ?></td>
                              <td class="text-right"><input type="text" name="page_form_pro_field[<?php echo $field_row; ?>][option_value][<?php echo $page_form_pro_option_value_row; ?>][sort_order]" value="<?php echo $page_form_pro_option_value['sort_order']; ?>" class="form-control" /></td>
                              <td class="text-right"><button type="button" onclick="$('#pageformoption-value-row<?php echo $field_row; ?>-<?php echo $page_form_pro_option_value_row; ?>').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                            </tr>
                            <?php $page_form_pro_option_value_row++; ?>
                            <?php } ?>
                            <?php } ?>
                          </tbody>
                          <tfoot>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="customer-email-language<?php echo $language['language_id']; ?>">
                        <div class="form-group required">
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="page_form_pro_description[<?php echo $language['language_id']; ?>][customer_subject]" value="<?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['customer_subject'] : ''; ?>" placeholder="<?php echo $entry_customer_subject; ?>" id="input-customer-subject<?php echo $language['language_id']; ?>" class="form-control" />
                        ...
                        <div class="form-group required">
                          ...
                          <div class="col-sm-10">
                            <textarea name="page_form_pro_description[<?php echo $language['language_id']; ?>][customer_message]" placeholder="<?php echo $entry_customer_message; ?>" id="input-customer-message<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['customer_message'] : ''; ?></textarea>
                    ...
                    <div class="tab-content">
                      ...
                      <div class="tab-pane" id="admin-email-language<?php echo $language['language_id']; ?>">
                        ...
                        <div class="form-group required">
                          ...
                          <div class="col-sm-10">
                            <textarea name="page_form_pro_description[<?php echo $language['language_id']; ?>][admin_message]" placeholder="<?php echo $entry_admin_message; ?>" id="input-admin-message<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['admin_message'] : ''; ?></textarea>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="success-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea name="page_form_pro_description[<?php echo $language['language_id']; ?>][success_description]" placeholder="<?php echo $entry_success_description; ?>" id="input-success-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($page_form_pro_description[$language['language_id']]) ? $page_form_pro_description[$language['language_id']]['success_description'] : ''; ?></textarea>
...
function addField() {
  html = '<div class="tab-pane" id="tab-field' + field_row + '">';
    html += '<fieldset>';
      ...
      html += '<input type="hidden" name="page_form_pro_field[' + field_row + '][page_form_pro_option_id]" value="" />';
          ...
          html += '<div class="tab-pane" id="field-language' + field_row + '-<?php echo $language['language_id']; ?>">';
            html += '<div class="form-group required">';
              ...
              html += '<div class="col-sm-12">';
                html += '<input type="text" name="page_form_pro_field[' + field_row + '][description][<?php echo $language['language_id']; ?>][field_name]" value="" placeholder="<?php echo $entry_field_name; ?>" class="form-control" />';
              html += '</div>';
            html += '</div>';
            html += '<div class="form-group">';
              ...
              html += '<div class="col-sm-12">';
                html += '<textarea name="page_form_pro_field[' + field_row + '][description][<?php echo $language['language_id']; ?>][field_help]" placeholder="<?php echo $entry_field_help; ?>" class="form-control"></textarea>';
              html += '</div>';
            html += '</div>';
            html += '<div class="form-group field-placeholder' + field_row + '">';
              ...
              html += '<div class="col-sm-12">';
                html += '<input type="text" name="page_form_pro_field[' + field_row + '][description][<?php echo $language['language_id']; ?>][field_placeholder]" value="" placeholder="<?php echo $entry_field_placeholder; ?>" class="form-control" />';
              html += '</div>';
            html += '</div>';
            html += '<div class="form-group field-error' + field_row + '">';
              ...
              html += '<div class="col-sm-12">';
                html += '<input type="text" name="page_form_pro_field[' + field_row + '][description][<?php echo $language['language_id']; ?>][field_error]" value="" placeholder="<?php echo $entry_field_error; ?>" class="form-control" />';
              html += '</div>';
            html += '</div>';
          html += '</div>';
          <?php } ?>
    ...
    html += '<fieldset>';
      html += '<legend><?php echo $text_type_setting ?></legend>';
          html += '<div class="form-group">';
            ...
            html += '<div class="col-sm-12">';
              html += '<select name="page_form_pro_field[' + field_row + '][status]" class="form-control field-status" rel="' + field_row + '">';
          ...
          html += '<div class="form-group">';
            ...
            html += '<div class="col-sm-12">';
              html += '<select name="page_form_pro_field[' + field_row + '][required]" class="form-control field-required" rel="' + field_row + '">';
          ...
          html += '<div class="form-group hide">';
            ...
            html += '<div class="col-sm-12">';
              html += '<input type="text" name="page_form_pro_field[' + field_row + '][sort_order]"  value="' + (field_row + parseInt(1)) + '" class="form-control field-sortorder" />';
            html += '</div>';
          html += '</div>';
          html += '<div class="form-group">';
            ...
            html += '<div class="col-sm-12">';
              html += '<select name="page_form_pro_field[' + field_row + '][type]" class="form-control field-type" rel="' + field_row + '">';
  ...
  $('select[name=\'page_form_pro_field[' + field_row + '][required]\'].field-required').trigger('change');
  $('select[name=\'page_form_pro_field[' + field_row + '][type]\'].field-type').trigger('change');
...
var page_form_pro_option_value_row = '<?php echo (isset($page_form_pro_option_value_row) ? $page_form_pro_option_value_row : 0); ?>';

function addPageFormOptionValue(field_row) {
  html  = '<tr id="pageformoption-value-row' + field_row + '-' + page_form_pro_option_value_row + '">'; 
    html += '  <td class="text-left"><input type="hidden" name="page_form_pro_field[' + field_row + '][option_value][' + page_form_pro_option_value_row + '][page_form_pro_option_value_id]" value="" />';
  <?php foreach ($languages as $language) { ?>
  ...
  html += '<img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />';
  <?php } ?>
  html += '</span><input type="text" name="page_form_pro_field[' + field_row + '][option_value][' + page_form_pro_option_value_row + '][page_form_pro_option_value_description][<?php echo $language['language_id']; ?>][name]" value="" placeholder="<?php echo $entry_option_value; ?>" class="form-control" />';
    html += '    </div>';
  <?php } ?>
  html += '  </td>';
  html += '  <td class="text-right"><input type="text" name="page_form_pro_field[' + field_row + '][option_value][' + page_form_pro_option_value_row + '][sort_order]" value="" placeholder="<?php echo $entry_sort_order; ?>" class="form-control" /></td>';
  html += '  <td class="text-right"><button type="button" onclick="$(\'#pageformoption-value-row' + field_row + '-' + page_form_pro_option_value_row + '\').remove();" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>';
  html += '</tr>';  
  
  $('#pageformoption-value' + field_row + ' tbody').append(html);
  
  page_form_pro_option_value_row++;
}
//--></script>
<script type="text/javascript"><!--
...
$('input[name=\'product\']').autocomplete({
  ...
  'select': function(item) {
    ...
    $('#formbuilder-product').append('<div id="formbuilder-product' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="page_form_pro_product[]" value="' + item['value'] + '" /></div>');  
  }
});
