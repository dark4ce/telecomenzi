  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
          <img style="margin-right:20px;" src="<?php echo HTTP_SERVER; ?>image/gls-logo.png">
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'order_status') { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left"><?php if ($sort == 'order_gls_status') { ?>
                        <a href="<?php echo $sort_gls_status; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_gls_status; ?></a>
                        <?php } else { ?>
                        <a href="<?php echo $sort_gls_status; ?>"><?php echo $column_gls_status; ?></a>
                    <?php } ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $order['gls_status']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=sale/order/ordersgls&token=<?php echo $token; ?>';
