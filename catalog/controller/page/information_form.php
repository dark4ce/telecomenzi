		...
		if($page_form_info) {
			...
			if(VERSION < '2.2.0.0') {
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/page/information_form.tpl')) {
					return $this->load->view($this->config->get('config_template') . '/template/page/information_form.tpl', $data);
				} else {
					return $this->load->view('default/template/page/information_form.tpl', $data);
				}
			} else{
