            ...
            <div class="mega-menu-item <?php echo $menu_item['classes']; ?> <?php echo $menu_item['show_class']; ?>">
                <div>
                    ...
                    <?php if (in_array($menu_item['show'], array('image', 'both'))): ?>
                        <a href="<?php echo $submenu_item['href']; ?>" class="sprite-logo-a">
                        
                            <div class="sprite-logo">
                                <?php $spriteName = strtolower(str_replace(" ", "-", $submenu_item['name']));
                                ?>
                                <div class="sprite-<?php echo $spriteName; ?>"></div>
                            </div>

                            <!--<img width="<?php echo $submenu_item['image_width']; ?>" height="<?php echo $submenu_item['image_height']; ?>" class="lazy" src="<?php echo $submenu_item['dummy']; ?>" data-src="<?php echo $submenu_item['image']; ?>" data-default-src="<?php echo $submenu_item['image']; ?>" alt="<?php echo $submenu_item['name']; ?>"/>
                            -->
                        </a>
                    <?php endif; ?>
                    ...
                    <ul>
                        <?php $index = 0; foreach ($submenu_item['items'] as $sub2menu_item): if ($menu_item['limit'] && $menu_item['limit'] <= $index) continue; $index++; ?>
                            <li data-image="<?php echo $sub2menu_item['image']; ?>">
                                <a href="<?php echo $sub2menu_item['href']; ?>"><?php echo $sub2menu_item['name']; ?></a>
                            </li>
                        <?php endforeach; ?>
                        <?php if ($menu_item['limit'] && $menu_item['limit'] <= $index): ?>
                            <li class="view-more">
                                <a href="<?php echo $submenu_item['href']; ?>"><?php echo $this->journal2->settings->get('view_more_text'); ?></a>
                            </li>
                        <?php endif; ?>
                    </ul>
                    <?php endif; ?>
