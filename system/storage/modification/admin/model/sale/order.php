...
class ModelSaleOrder extends Model {
			...
			public function getOrdersGls($data = array()) {
		$sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.name FROM " . DB_PREFIX . "order_status os WHERE os.order_status_id = o.order_status_id AND os.language_id = '" . (int)$this->config->get('config_language_id') . "') AS order_status, o.shipping_code, o.total, o.currency_code, o.currency_value, o.date_added, o.date_modified, o.gls_track FROM `" . DB_PREFIX . "order` o";
	...
	public function getGlsPostcodes() {
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "postcodes");
		return $query->rows;
	}
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			'gls_track'           	  => $order_query->row['gls_track'] // ZAMFI MODIFICATION GLS
