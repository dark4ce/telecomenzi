  ...
  <div class="page-header">
    <div class="container-fluid">
			...
			<div class="pull-right">
                ...
                <a href="<?php echo $smartbill; ?>" target="_blank" data-toggle="tooltip" title="<?php echo $button_smartbill; ?>" class="btn btn-info pull-right" style="margin-right: 10px;"><?php echo $button_smartbill; ?></a>
            
			<a target="_blank" class="btn btn-info" href="<?php echo $glslabel; ?>">GLS - Custom Label</a>
			<a target="_blank" class="btn btn-info" href="<?php echo $glslabel_print; ?>">GLS - Print Label</a>
      ...
      <div class="panel-body">
        ...
        <div class="tab-content">
          ...
          <?php } ?>
			...
			<!-- ZAMFI GLS MODIFICATION START -->
    <div class="container-fluid">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-comment-o"></i> GLS Tracking History </h3>
            </div>
            <div class="panel-body">
                <?php if(isset($tracking_gls)) { ?>
                <table class="table table-bordered table-hover">
                    <thead>
                    <tr>
                        <td class="text-left">Date</td>
                        <td class="text-left">Hour</td>
                        <td class="text-left">Status</td>
                    </tr>
                    </thead>
                    <tbody>
                    <?php foreach($tracking_gls as $tracking) { ?>
                    <tr>
                        <td class="text-left"><?php echo date('Y-m-d',strtotime($tracking['StDate'])); ?></td>
                        <td class="text-left"><?php echo date('H:i:s',strtotime($tracking['StDate'])); ?></td>
                        <td class="text-left"><?php echo $status_code[$tracking['StCode']]; ?></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                </table>
