        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                <td class="text-left"><a title="View Detail and Map" href="http://ip2address.info/ip/<?php echo $customer['ip']; ?>" target="_blank"><?php echo $customer['ip']; ?> (<?php if(isset($customer['flag']) && file_exists(DIR_APPLICATION.'view/image/flags/'.$customer['flag'].'.png')) { ?> <img src="view/image/flags/<?php echo $customer['flag']; ?>.png"><?php } ?> <?php echo $customer['country'] != '' ? $customer['country'] : 'unknown' ; ?> )</a></td>
